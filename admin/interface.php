    ...
    <div class="wrap" style="overflow: hidden;">
        <div class="wrap">
            <div style="display: flex; align-items: center; gap: 10px; padding-top: 10px; margin-bottom: 20px;">
                ...
                <div style="display: flex; gap: 4px; margin-left: 10px;">
                    <button id="pmc-file-btn" class="page-title-action"
                ...
                <input type="file" id="pmc-file-input" accept=".pdf,.svg,.jpg,.jpeg,.png,.webp,.avif,.bmp"
                    style="display:none;">
            ...
            <div class="pmc-container">
                <div class="pmc-main">
                    <div class="pmc-editor-wrapper">
                        <div id="pmc-loading">Processing...</div><img id="pmc-image">
                    </div>
                </div>
                <div class="pmc-sidebar">
                    ...
                    <div id="pillarbox-controls" style="display:none;">
                        <div class="pmc-row"><label>Pillar Style</label><select id="pmc-mode" style="width: 100%;">
                        ...
                        <div class="pmc-row" id="blur-wrap"><label>Blur Intensity</label><input type="range" id="pmc-blur"
                                min="0" max="80" value="30" style="width: 100%;"></div>
                    </div>
        ...
        <div id="pmc-search-modal">
            <div class="pmc-modal-inner">
                <div style="display:flex; gap:10px;"><select id="pmc-stock-provider">
                        <option value="pixabay">Pixabay</option>
                        <option value="unsplash">Unsplash</option>
                        <option value="pexels">Pexels</option>
                    </select><input type="text" id="pmc-stock-query" style="flex:1" placeholder="Search keywords..."><button
                        class="button button-primary" onclick="window.pmcStartNewSearch()">Search</button><button
                        class="button"
                        onclick="document.getElementById('pmc-search-modal').style.display='none'">Close</button></div>
